...
public class MusicPlayerService extends Service implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static final String NOTIFY_PREVIOUS = "ru.isaynet.android.musicplayer.previous";
    public static final String NOTIFY_CLOSE = "ru.isaynet.android.musicplayer.close";
    public static final String NOTIFY_PAUSE = "ru.isaynet.android.musicplayer.pause";
    public static final String NOTIFY_PLAY = "ru.isaynet.android.musicplayer.play";
    public static final String NOTIFY_NEXT = "ru.isaynet.android.musicplayer.next";
