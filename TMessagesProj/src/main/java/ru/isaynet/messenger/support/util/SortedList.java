 ...
 * list
 * such that it can be bound to a {@link ru.isaynet.messenger.support.widget.RecyclerView.Adapter
...
public class SortedList<T> {
    ...
    public static abstract class Callback<T2> implements Comparator<T2>, ListUpdateCallback {
         ...
         * <p>
         * For example, if you are using SortedList with a {@link ru.isaynet.messenger.support.widget.RecyclerView.Adapter
