...
public final class ExoPlayerLibraryInfo {
  ...
  /**
   * Whether the library was compiled with {@link ru.isaynet.messenger.exoplayer2.util.Assertions}
   * checks enabled.
   */
  public static final boolean ASSERTIONS_ENABLED = true;

  /**
   * Whether the library was compiled with {@link ru.isaynet.messenger.exoplayer2.util.TraceUtil}
   * trace enabled.
   */
