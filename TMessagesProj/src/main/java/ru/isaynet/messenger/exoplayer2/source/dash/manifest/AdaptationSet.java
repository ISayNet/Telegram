...
public class AdaptationSet {
  ...
  /**
   * The type of the adaptation set. One of the {@link ru.isaynet.messenger.exoplayer2.C}
   ...
   * @param type The type of the adaptation set. One of the {@link ru.isaynet.messenger.exoplayer2.C}
   *     {@code TRACK_TYPE_*} constants.
