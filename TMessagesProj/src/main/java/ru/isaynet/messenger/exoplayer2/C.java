...
public final class C {
  ...
  /**
   * Content types for {@link ru.isaynet.messenger.exoplayer2.audio.AudioAttributes}.
   */
  @Retention(RetentionPolicy.SOURCE)
  ...
  /**
   * Flags for {@link ru.isaynet.messenger.exoplayer2.audio.AudioAttributes}.
   * <p>
  ...
  /**
   * Usage types for {@link ru.isaynet.messenger.exoplayer2.audio.AudioAttributes}.
   */
  @Retention(RetentionPolicy.SOURCE)
   ...
   * A type of a message that can be passed to an audio {@link Renderer} via
   * {@link ExoPlayer#sendMessages} or {@link ExoPlayer#blockingSendMessages}. The message object
   * should be an {@link ru.isaynet.messenger.exoplayer2.audio.AudioAttributes} instance that will
