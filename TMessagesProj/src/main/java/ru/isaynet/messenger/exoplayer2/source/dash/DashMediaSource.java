...
import ru.isaynet.messenger.exoplayer2.ExoPlayerLibraryInfo;
import ru.isaynet.messenger.exoplayer2.ParserException;
import ru.isaynet.messenger.exoplayer2.Timeline;
import ru.isaynet.messenger.exoplayer2.source.AdaptiveMediaSourceEventListener;
import ru.isaynet.messenger.exoplayer2.source.AdaptiveMediaSourceEventListener.EventDispatcher;
import ru.isaynet.messenger.exoplayer2.source.MediaPeriod;
...
import ru.isaynet.messenger.exoplayer2.source.dash.manifest.DashManifestParser;
import ru.isaynet.messenger.exoplayer2.source.dash.manifest.UtcTimingElement;
...
import ru.isaynet.messenger.exoplayer2.upstream.ParsingLoadable;
...
public final class DashMediaSource implements MediaSource {
  ...
  private static final class PeriodSeekInfo {
    ...
    public static PeriodSeekInfo createPeriodSeekInfo(
        ru.isaynet.messenger.exoplayer2.source.dash.manifest.Period period, long durationUs) {
  ...
  private static final class DashTimeline extends Timeline {
    ...
    private long getAdjustedWindowDefaultStartPositionUs(long defaultPositionProjectionUs) {
      ...
      ru.isaynet.messenger.exoplayer2.source.dash.manifest.Period period =
