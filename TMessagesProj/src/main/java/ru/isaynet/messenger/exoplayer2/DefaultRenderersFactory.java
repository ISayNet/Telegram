 ...
 */
package ru.isaynet.messenger.exoplayer2;
...
import ru.isaynet.messenger.exoplayer2.audio.AudioCapabilities;
import ru.isaynet.messenger.exoplayer2.audio.AudioProcessor;
import ru.isaynet.messenger.exoplayer2.audio.AudioRendererEventListener;
import ru.isaynet.messenger.exoplayer2.audio.MediaCodecAudioRenderer;
import ru.isaynet.messenger.exoplayer2.drm.DrmSessionManager;
import ru.isaynet.messenger.exoplayer2.drm.FrameworkMediaCrypto;
import ru.isaynet.messenger.exoplayer2.mediacodec.MediaCodecSelector;
import ru.isaynet.messenger.exoplayer2.metadata.MetadataRenderer;
import ru.isaynet.messenger.exoplayer2.text.TextRenderer;
import ru.isaynet.messenger.exoplayer2.trackselection.TrackSelector;
import ru.isaynet.messenger.exoplayer2.video.MediaCodecVideoRenderer;
import ru.isaynet.messenger.exoplayer2.video.VideoRendererEventListener;
...
public class DefaultRenderersFactory implements RenderersFactory {
  ...
  protected void buildVideoRenderers(Context context,
    ...
    try {
      Class<?> clazz =
          Class.forName("ru.isaynet.messenger.exoplayer2.ext.vp9.LibvpxVideoRenderer");
  ...
  protected void buildAudioRenderers(Context context,
    ...
    try {
      Class<?> clazz =
          Class.forName("ru.isaynet.messenger.exoplayer2.ext.opus.LibopusAudioRenderer");
    ...
    try {
      Class<?> clazz =
          Class.forName("ru.isaynet.messenger.exoplayer2.ext.flac.LibflacAudioRenderer");
      Constructor<?> constructor = clazz.getConstructor(Handler.class,
          AudioRendererEventListener.class, AudioProcessor[].class);
      Renderer renderer = (Renderer) constructor.newInstance(eventHandler, eventListener,
          audioProcessors);
    ...
    try {
      Class<?> clazz =
          Class.forName("ru.isaynet.messenger.exoplayer2.ext.ffmpeg.FfmpegAudioRenderer");
      Constructor<?> constructor = clazz.getConstructor(Handler.class,
          AudioRendererEventListener.class, AudioProcessor[].class);
      Renderer renderer = (Renderer) constructor.newInstance(eventHandler, eventListener,
          audioProcessors);
