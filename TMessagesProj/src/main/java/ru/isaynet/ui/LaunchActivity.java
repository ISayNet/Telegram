...
import ru.isaynet.messenger.LocationController;
...
import ru.isaynet.messenger.NativeCrashManager;
...
import ru.isaynet.messenger.camera.CameraController;
...
import ru.isaynet.ui.Adapters.DrawerLayoutAdapter;
import ru.isaynet.ui.ActionBar.ActionBarLayout;
import ru.isaynet.ui.ActionBar.BaseFragment;
import ru.isaynet.ui.ActionBar.DrawerLayoutContainer;
import ru.isaynet.ui.Cells.LanguageCell;
import ru.isaynet.ui.Components.AudioPlayerAlert;
        ...
        if (!fromPassword && (AndroidUtilities.needShowPasscode(true) || UserConfig.isWaitingForPasscodeEnter)) {
            ...
            if (UserConfig.isClientActivated() && (flags & Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY) == 0) {
                if (intent != null && intent.getAction() != null && !restore) {
                    ...
                    } else if (intent.getAction().equals("ru.isaynet.messenger.OPEN_ACCOUNT")) {
                        open_settings = 1;
