...
jobjectArray
Java_ru_isaynet_messenger_Emoji_getSuggestion(JNIEnv *env, jobject object, jstring query) {
    ...
    if (jclass_Suggestion == nullptr) {
        jclass_Suggestion = (jclass) env->NewGlobalRef(env->FindClass("ru/isaynet/messenger/EmojiSuggestion"));
