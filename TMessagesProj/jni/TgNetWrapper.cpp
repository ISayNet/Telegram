...
static const char *FileLoadOperationClassPathName = "ru/isaynet/tgnet/FileLoadOperation";
...
static const char *NativeByteBufferClassPathName = "ru/isaynet/tgnet/NativeByteBuffer";
...
static const char *ConnectionsManagerClassPathName = "ru/isaynet/tgnet/ConnectionsManager";
static JNINativeMethod ConnectionsManagerMethods[] = {
        ...
        {"native_sendRequest", "(ILru/isaynet/tgnet/RequestDelegateInternal;Lru/isaynet/tgnet/QuickAckDelegate;Lru/isaynet/tgnet/WriteToSocketDelegate;IIIZI)V", (void *) sendRequest},
...
extern "C" int registerNativeTgNetFunctions(JavaVM *vm, JNIEnv *env) {
    ...
    jclass_RequestDelegateInternal = (jclass) env->NewGlobalRef(env->FindClass("ru/isaynet/tgnet/RequestDelegateInternal"));
    ...
    jclass_QuickAckDelegate = (jclass) env->NewGlobalRef(env->FindClass("ru/isaynet/tgnet/QuickAckDelegate"));
    if (jclass_RequestDelegateInternal == 0) {
        return JNI_FALSE;
    }
    ...
    jclass_WriteToSocketDelegate = (jclass) env->NewGlobalRef(env->FindClass("ru/isaynet/tgnet/WriteToSocketDelegate"));
    ...
    jclass_FileLoadOperationDelegate = (jclass) env->NewGlobalRef(env->FindClass("ru/isaynet/tgnet/FileLoadOperationDelegate"));
    ...
    jclass_ConnectionsManager = (jclass) env->NewGlobalRef(env->FindClass("ru/isaynet/tgnet/ConnectionsManager"));
